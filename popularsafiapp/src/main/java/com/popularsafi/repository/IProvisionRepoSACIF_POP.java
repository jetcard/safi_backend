...
public interface IProvisionRepoSACIF_POP extends IGenericRepo<ReporteProvision, Long> {
    @Query(value =
            "SELECT DVALOR_BV, CMONEDA, " +
                    ...
                    " FROM "+ Constantes.SACIF_POP+".TMP_CALCULO_IC2 WHERE INTERESPROV != 0 ", nativeQuery = true)
