...
public class ExcelRiesgos {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<ReporteRiesgo> reporteRiesgo;

    public ExcelRiesgos(List<ReporteRiesgo> listaRiesgos) {
    ...
    private void writeHeaderLine(String fechaProceso) {
        ...
        CellRangeAddress mergedRegion0 = new CellRangeAddress(0,0,1,34);
        ...
        createCell(row, 10, "CUBIGEO", styleHeaders);
        ...
        createCell(row, 20, "SUELDO", styleHeaders);
        ...
        createCell(row, 30, "F_VALORIZACION", styleHeaders);
        createCell(row, 31, "DISTRITO_1", styleHeaders);
        createCell(row, 32, "NCUOTAS_GENERADAS", styleHeaders);
        createCell(row, 33, "CUOTASATRASADAS", styleHeaders);
        createCell(row, 34, "FONDO", styleHeaders);
    ...
    private void writeDataLines() {
        ...
        font1.setBold(true);
        font1.setFontHeight(17);
        styleTop.setFont(font1);
        styleTop.setAlignment(HorizontalAlignment.CENTER);
        ...
        for( ReporteRiesgo result: reporteRiesgo) {
            ...
            createCell(row, columnCount++, result.getCMONEDA(), style);
            createCell(row, columnCount++, result.getNdocumento(), style);
            createCell(row, columnCount++, result.getTapaterno(), style);
            createCell(row, columnCount++, result.getTamaterno(), style);
            ...
            createCell(row, columnCount++, Constantes.SACIF_DESCRIP, style);
        }
    }
