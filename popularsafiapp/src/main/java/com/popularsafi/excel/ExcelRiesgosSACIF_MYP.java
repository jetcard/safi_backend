...
public class ExcelRiesgosSACIF_MYP {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<ReporteRiesgo> reporteRiesgo;

    public ExcelRiesgosSACIF_MYP(List<ReporteRiesgo> listaRiesgos) {
    ...
    private void writeDataLines() {
        ...
        for( ReporteRiesgo result: reporteRiesgo) {
            ...
            createCell(row, columnCount++, Constantes.SACIF_MYP_DESCRIP, style);
        }
    }
